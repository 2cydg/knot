...
func listTagCompleter(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
	if len(args) > 0 {
		return nil, cobra.ShellCompDirectiveNoFileComp
	}
	...
	return filterAndSortCompletions(cfg.GetAllTags(), toComplete), cobra.ShellCompDirectiveNoFileComp
}
